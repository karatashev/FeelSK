  ...
  return (
    <div className="w-full h-screen relative">
      ...
      <div className="absolute top-0 w-full h-full flex flex-col justify-center text-center text-white p-4">
        <h1>The Capital of <span className="text-red-600">Macedonia</span></h1>
        <h2 className="py-4">The City of history, solidarity & diversity</h2>
        <form className="flex justify-between items-center max-w-[700px] mx-auto w-full border p-1 rounded-md text-black bg-gray-100/90">
          <div>
            <input className="bg-transparent w-[300px] sm:w-[400px] font-[Montserrat] focus:outline-none" type="text" placeholder="Search for amenities"/>
          </div>
          <div>
